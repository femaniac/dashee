...
function loadUsers(){
    ...
    users.map(user => {
        user.gender ? (userGender = '<td>Male</td>') : (userGender = '<td>Female</td>')
        ...
        <tr>
            ...
            <td>${user.role}</td>
            <td></td>
            <td><ion-icon data-toggle="modal" data-target="#editModal" style="font-size: 35px; color: #4DB145; cursor: pointer" onclick="editUser(${user.id})" name="create-outline"></ion-icon></td>
            <td><ion-icon style="font-size: 35px; color: red; cursor:pointer" onclick="deleteUser(${user.id})" name="close-circle-outline"></ion-icon></td>
